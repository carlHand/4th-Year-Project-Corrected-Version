 ...
 */
public class ExpandableListGenre extends BaseExpandableListAdapter {
    ...
    public ExpandableListGenre(Context context, LayoutInflater layoutInflater, FragmentManager fm, List<String> listDataHeader,
...
*/
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded,
        ...
        View v = convertView.inflate(_context, R.layout.expandable_group_layout, null);
        ...
        info.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(groupPosition == 0) {
                    BeginnerDialog dialog1 = new BeginnerDialog();
                    dialog1.show(fragmentManager, "MyDialog1");
                }
                if(groupPosition == 1) {
                    IntermediateDialog dialog2 = new IntermediateDialog();
                    dialog2.show(fragmentManager, "MyDialog2");
                }
                if(groupPosition == 2) {
                    AdvancedDialog dialog3 = new AdvancedDialog();
